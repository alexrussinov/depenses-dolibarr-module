...
/**
 * 		\defgroup   Depenses module
 *      \brief      Descriptor of the Depenses module.		
 */

/**
 *      \file       htdocs/includes/modules/modDepenses.class.php
 *      \ingroup    Depenses module
 *      \brief      Description and activation file for module Depenses
...
/**
 * 		\class      modDepenses
 *      \brief      Description and activation class for module Depenses
 */
class modDepenses extends DolibarrModules
{
	/**
	 *   \brief      Constructor. Define names, constants, directories, boxes, permissions
	 *   \param      DB      Database handler
	 */
	function modDepenses($DB)
	{
        global $langs,$conf;
        $langs->Load('depenses');
		...
		$this->description = "Enregistrement de factures des depenses";
		...
		$this->picto='icondepenses@factures_depenses';
		...
		$this->config_page_url = array("depensessetup.php");
		...
		*/
		...
		// Example:
		 ...
		 $this->rights[$r][1] = 'Creer/Modifier les depenses';	// Permission label
		 $this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
		 $this->rights[$r][4] = 'w';				// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
		 ...
		 $this->rights[$r][1] = 'Creer/Modifier les depenses';	// Permission label
		 $this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
		 $this->rights[$r][4] = 'd';				// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
		...
		// Example to declare the Top Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>0,			// Put 0 if this is a top menu
								...
								'titre'=>$langs->trans("Depenses"),
								'mainmenu'=>'depenses',
								'leftmenu'=>'1',		// Use 1 if you also want to add left menu entries using this descriptor.
    							'url'=>'/factures_depenses/index.php',
		...
		// Example to declare another Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=1',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									'type'=>'left',			// This is a Left menu entry
									'titre'=>$langs->trans("CreateBill"),
									'mainmenu'=>'depenses',
									'url'=>'/factures_depenses/fiche.php?action=create',
		//							'langs'=>'mylangfile',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'1',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
		//							'perms'=>'1',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		//							'target'=>'',
		 ...
		 $this->menu[$r]=array(	'fk_menu'=>'r=1',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
		 		'type'=>'left',			// This is a Left menu entry
		 		'titre'=>$langs->trans("Unpayed"),
		 		'mainmenu'=>'depenses',
		 		'url'=>'/factures_depenses/impayees.php',
		 		//							'langs'=>'mylangfile',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		 		//							'position'=>100,
		 		//							'enabled'=>'1',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
		 		//							'perms'=>'1',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		 ...
		 $this->menu[$r]=array(	'fk_menu'=>'r=1',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
		 		'type'=>'left',			// This is a Left menu entry
		 		'titre'=>$langs->trans("Payements"),
		 		'mainmenu'=>'depenses',
		 		'url'=>'/factures_depenses/paymentdep.php',
		 		//							'langs'=>'mylangfile',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		 		//							'position'=>100,
		 		//							'enabled'=>'1',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
		 		//							'perms'=>'1',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		 ...
		 $this->menu[$r]=array(	'fk_menu'=>'r=1',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
		 		'type'=>'left',			// This is a Left menu entry
		 		'titre'=>$langs->trans("Raports"),
		 		'mainmenu'=>'depenses',
		 		'url'=>'/factures_depenses/raports.php',
		 		//							'langs'=>'mylangfile',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		 		//							'position'=>100,
		 		//							'enabled'=>'1',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
		 		//							'perms'=>'1',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
	...
	{
		return $this->_load_tables('/factures_depenses/sql/');
	}
}
