...
div.mainmenu.depenses {
	background-image: url(<?php echo DOL_URL_ROOT.'/factures_depenses/img/icondep.png' ?>); /*By alex*/
}
...
$generic=1;
$divalreadydefined=array('home','companies','products','commercial','accountancy','project','tools','members','shop','agenda','ecm','cashdesk', 'depenses');
